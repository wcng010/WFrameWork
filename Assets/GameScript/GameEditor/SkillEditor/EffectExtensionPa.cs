...
namespace Wcng.SkillEditor
{
    [Serializable]
    [NotKeyable]
    public class EffectExtensionPa : PlayableAsset, IPropertyPreview, ITimelineClipAsset
    {
        ...
        [SerializeField] public ExposedReference<GameObject> sourceGameObject
        {
            get
            {
                if (!_sourceGameObject.defaultValue)
                    _sourceGameObject.defaultValue = GameObject.FindWithTag("PlayerEffect");
                return _sourceGameObject;
            }
            set
            {
                _sourceGameObject = value;
            }
        }

        [SerializeField] private ExposedReference<GameObject> _sourceGameObject;
            /// <summary>
